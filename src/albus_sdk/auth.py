...
class Auth(BaseSDK):
    ...
    def whoami(
        ...
        *,
        request: Union[
            operations.WhoamiRequest, operations.WhoamiRequestTypedDict
        ] = operations.WhoamiRequest(),
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.WhoamiRequest)
        request = cast(operations.WhoamiRequest, request)
        ...
        req = self._build_request(
            ...
            _globals=operations.WhoamiGlobals(
