...
class Tokens(BaseSDK):
    ...
    def list_tokens(
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.ListTokensResponse, http_res)
    ...
    def create_token(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.CreateTokenResponse, http_res)
        if utils.match_response(http_res, "401", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrUnauthorizedData, http_res
            )
    ...
    def get_token(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.Token, http_res)
        if utils.match_response(http_res, "401", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrUnauthorizedData, http_res
            )
...
class AsyncTokens(AsyncBaseSDK):
    r"""Manage organization API keys."""
