...
class RevokeInviteGlobalsTypedDict(TypedDict):
...
class RevokeInviteGlobals(BaseModel):
...
class RevokeInviteRequestTypedDict(TypedDict):
    id: str
    r"""The invitation identifier."""
