...
class GetSessionAuditGlobalsTypedDict(TypedDict):
...
class GetSessionAuditGlobals(BaseModel):
...
class GetSessionAuditRequestTypedDict(TypedDict):
    id: str
...
class GetSessionAuditRequest(BaseModel):
    id: Annotated[
